...
class Categories extends \WP_Widget
{
	...
	public function __construct()
	{
		...
		parent::__construct(
			'adqs_categories',  // Base ID
			esc_html__('AD : Categories', 'adirectory'), // Name
			array('description' => esc_html__('You can display listings categories.', 'adirectory')) // Args
		);
	}
