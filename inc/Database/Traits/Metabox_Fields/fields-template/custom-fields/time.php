...
$label   = $Helper->get_data( $data, 'label', esc_html__( 'Time', 'adirectory' ) );
...
<div class="qsd-form-group qsd-time-field">
	<h4 class="qsd-form-label">
		<?php echo esc_html( $label ); ?>:
		<?php $Helper->required_html( $data ); ?>
	</h4>
	<div class="qsd-form-wrap qsd-form-field">
		<input type="time" name="<?php echo esc_attr( $name ); ?>" id="<?php echo esc_attr( $name ); ?>"
